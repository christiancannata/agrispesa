<?php 
class WCCCF_FieldCustomConfiguratorPage
{
	...
	{
		$this->page = add_submenu_page( 'woocommerce-conditional-checkout-fields', esc_html__('Custom Fields', 'woocommerce-conditional-checkout-fields'),esc_html__('Custom Fields', 'woocommerce-conditional-checkout-fields'), $cap, 'woocommerce-conditional-checkout-fields', array($this, 'render_page'));
	...
	public function render_page()
	{
		...
		wp_enqueue_script( 'admin-load-tag-list', WCCCF_PLUGIN_PATH.'/js/admin-load-tag-list.js', array('jquery'));	
		wp_enqueue_script( 'admin-user-role-list', WCCCF_PLUGIN_PATH.'/js/admin-user-role-list.js', array('jquery'));	
		wp_enqueue_script( 'admin-customer-name-list', WCCCF_PLUGIN_PATH.'/js/admin-customer-list.js', array('jquery'));	
		...
		<div class="wrap">
			...
			<h2><?php esc_html_e('Custom Fields Configurator','woocommerce-conditional-checkout-fields'); ?></h2>
	...
	function add_billing_fields_meta_box()
	{
		...
		?>
			<div class="column " id="billing_fields_container">
				<?php  $wcccf_html_helper->render_field_custom_configuration_meta_box($field_data); ?>
			</div>
