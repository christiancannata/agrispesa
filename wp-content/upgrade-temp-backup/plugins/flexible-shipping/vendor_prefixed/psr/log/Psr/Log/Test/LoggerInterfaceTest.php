...
namespace FSVendor\Psr\Log\Test;

use FSVendor\Psr\Log\LoggerInterface;
use FSVendor\Psr\Log\LogLevel;
use FSVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('FSVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('FSVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('FSVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
