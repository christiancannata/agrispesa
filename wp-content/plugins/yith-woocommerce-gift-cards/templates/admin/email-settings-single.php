	...
	<form method="post" id="plugin-fw-wc" action="" enctype="multipart/form-data">
		...
		<p class="submit">
			<?php if ( ! isset( $GLOBALS['hide_save_button'] ) ) : ?>
				<button name="save" class="button-primary yith-plugin-fw__button--xl yith-ywgc-save-settings" type="submit" value="<?php esc_attr_e( 'Save', 'yith-woocommerce-gift-cards' ); ?>"><?php esc_html_e( 'Save', 'yith-woocommerce-gift-cards' ); ?></button>
			<?php endif; ?>
