...
$wfic_datatosend_url = "https://api-v2.fattureincloud.it/c/". $company_id ."/issued_documents/". $idricevuta ."/email";
...
$fattureincloud_url = "https://api.fattureincloud.it:443/v1/ricevute/inviamail";
...
$fattureincloud_request = array(
    ...
    //"messaggio" => "Gentile " .$nome_cliente_fic. " ,<br>\n in allegato la ricevuta dell'".$oggetto_ordine_fic." in versione PDF.
