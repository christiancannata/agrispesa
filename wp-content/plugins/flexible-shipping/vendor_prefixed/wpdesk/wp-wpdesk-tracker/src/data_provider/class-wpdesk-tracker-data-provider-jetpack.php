...
if (!\class_exists('FSVendor\WPDesk_Tracker_Data_Provider_Jetpack')) {
    ...
    class WPDesk_Tracker_Data_Provider_Jetpack implements \WPDesk_Tracker_Data_Provider
    {
        ...
        public function get_data()
        {
            ...
            $data['jetpack_connected'] = \class_exists('FSVendor\Jetpack') && \is_callable('FSVendor\Jetpack::is_active') && Jetpack::is_active() ? 'yes' : 'no';
            $data['jetpack_is_staging'] = \class_exists('FSVendor\Jetpack') && \is_callable('FSVendor\Jetpack::is_staging_site') && Jetpack::is_staging_site() ? 'yes' : 'no';
