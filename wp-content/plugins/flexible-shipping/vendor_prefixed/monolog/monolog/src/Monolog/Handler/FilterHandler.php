 ...
 */
class FilterHandler extends \FSVendor\Monolog\Handler\Handler implements \FSVendor\Monolog\Handler\ProcessableHandlerInterface, \FSVendor\Monolog\ResettableInterface, \FSVendor\Monolog\Handler\FormattableHandlerInterface
{
     ...
     */
    public function __construct($handler, $minLevelOrList = \FSVendor\Monolog\Logger::DEBUG, $maxLevel = \FSVendor\Monolog\Logger::EMERGENCY, bool $bubble = \true)
    {
     ...
     * @phpstan-param Level|LevelName|LogLevel::*                                    $maxLevel
     */
    public function setAcceptedLevels($minLevelOrList = \FSVendor\Monolog\Logger::DEBUG, $maxLevel = \FSVendor\Monolog\Logger::EMERGENCY) : self
    {
