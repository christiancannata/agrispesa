...
class Registry
{
     ...
     * @return void
     */
    public static function addLogger(\FSVendor\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
     ...
     */
    public static function getInstance($name) : \FSVendor\Monolog\Logger
    {
