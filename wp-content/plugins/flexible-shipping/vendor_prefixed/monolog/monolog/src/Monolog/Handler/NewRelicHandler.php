...
class NewRelicHandler extends \FSVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($level = \FSVendor\Monolog\Logger::ERROR, bool $bubble = \true, ?string $appName = null, bool $explodeArrays = \false, ?string $transactionName = null)
    {
