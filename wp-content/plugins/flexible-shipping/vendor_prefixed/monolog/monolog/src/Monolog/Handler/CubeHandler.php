...
class CubeHandler extends \FSVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(string $url, $level = \FSVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    protected function connectHttp() : void
    {
        if (!\extension_loaded('curl')) {
            throw new \FSVendor\Monolog\Handler\MissingExtensionException('The curl extension is required to use http URLs with the CubeHandler');
        }
