...
use FSVendor\PhpConsole\Handler as VendorPhpConsoleHandler;
...
class PHPConsoleHandler extends \FSVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(array $options = [], ?\FSVendor\PhpConsole\Connector $connector = null, $level = \FSVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    private function initConnector(?\FSVendor\PhpConsole\Connector $connector = null) : \FSVendor\PhpConsole\Connector
    {
        if (!$connector) {
    ...
    public function getConnector() : \FSVendor\PhpConsole\Connector
    {
