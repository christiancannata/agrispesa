...
class SlackRecord
{
     ...
     */
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = \true, ?string $userIcon = null, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array(), \FSVendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
    ...
    public function stringify(array $fields) : string
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \FSVendor\Monolog\Utils::jsonEncode($normalized, \JSON_PRETTY_PRINT | \FSVendor\Monolog\Utils::DEFAULT_JSON_FLAGS) : \FSVendor\Monolog\Utils::jsonEncode($normalized, \FSVendor\Monolog\Utils::DEFAULT_JSON_FLAGS);
    }
    /**
    ...
    public function setFormatter(?\FSVendor\Monolog\Formatter\FormatterInterface $formatter = null) : self
    {
