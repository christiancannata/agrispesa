...
abstract class VariationsParserBase extends Parser {
    ...
    private function getOptionName($option) {
        $optionsMapping = [
            'variable_file_paths' => 'variable_files',
            'variable_file_names' => 'variable_files_names'
        ];
        return str_replace('variable_', 'product_', isset($optionsMapping[$option]) ? $optionsMapping[$option] : $option);
    }
