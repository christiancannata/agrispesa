...
use wpai_woocommerce_add_on\importer\products\ImportExternalProduct;
use wpai_woocommerce_add_on\importer\products\ImportGroupedProduct;
use wpai_woocommerce_add_on\importer\products\ImportProductBase;
use wpai_woocommerce_add_on\importer\products\ImportSimpleProduct;
use wpai_woocommerce_add_on\importer\products\ImportSimpleSubscriptionProduct;
use wpai_woocommerce_add_on\importer\products\ImportVariableProduct;
use wpai_woocommerce_add_on\importer\products\ImportVariableSubscriptionProduct;
    ...
    public function afterPostImport() {
        ...
        if ($p) {
            ...
            if ($p->post_type == 'product_variation') {
                ...
                update_post_meta( $this->getPid(), '_product_version', \WC()->version );
