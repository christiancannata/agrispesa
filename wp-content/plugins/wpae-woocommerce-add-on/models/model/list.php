 ...
 */
class PMWE_Model_List extends PMXE_Model {
	...
	public function convertRecords($elementClass = NULL, $includeFields = NULL) {
		...
		if ( ! is_subclass_of($elementClass, PMWE_Plugin::PREFIX . 'Model_Record')) {
			throw new Exception("Provideded class name $elementClass must be a subclass of " . PMWE_Plugin::PREFIX . 'Model_Record');
		}
