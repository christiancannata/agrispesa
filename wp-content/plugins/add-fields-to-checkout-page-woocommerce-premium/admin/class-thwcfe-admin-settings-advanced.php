...
class THWCFE_Admin_Settings_Advanced extends THWCFE_Admin_Settings {
	...
	public function get_advanced_settings_fields(){
		...
		$fields_position_registration = array(
			'no_syncs' => 'No Synchronize',
			'registration_start' => 'Registration Fields Start',
			'registration_end' => 'Registration Fields End',
		);
		...
		return array(
			...
			'section_registration_settings' => array('title'=>'Synchronize Checkout Billing Fields into Registration Fields', 'type'=>'separator', 'colspan'=>'3'),
			'enable_checkout_billing_in_registration_fields' => array(
				'name'=>'enable_checkout_billing_in_registration_fields', 'label'=>'Checkout Billing Fields', 'type'=>'select', 'value'=>'no_syncs', 'options'=> $fields_position_registration
			),				
