...
function soChangeProductsTitle()
{
	...
	echo '<div class="product-loop-title-meta"><h6 class="' . esc_attr(apply_filters('woocommerce_product_loop_title_classes', 'woocommerce-loop-product__title')) . '">' . $title . '</h6>';
	echo '<span class="product-info--quantity">' . '' . '</span></div>';
