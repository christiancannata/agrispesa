				...
				while ($loop->have_posts()) : $loop->the_post(); ?>
					...
					<article id="post-<?php the_ID(); ?>" class="faq__item <?php echo 'faq-' . $i; ?>">
						<header class="faq__content">
							<h2 class="faq__title"><a href="<?php echo get_permalink(); ?>"
													  title="<?php the_title(); ?>" class="faq__link"><span
										class="faq__icon icon-arrow-down"></span><?php the_title(); ?></a></h2>
		...
		<section class="landing-ingredients">
			...
			<div class="landing-ingredients--flex">
				...
				<div class="landing-ingredients--sx" data-aos="fade-uo" data-aos-duration="800" data-aos-delay="150">
					<img class="landing-meet--image sticky"
						 src="<?php echo get_template_directory_uri(); ?>/assets/images/petfood/camomilla.svg"
						 alt="Per ogni razza, per ogni tipetto."/>
				</div>
				<div class="landing-ingredients--dx">
					...
					if ($the_query->have_posts()) : $i = 1;
						while ($the_query->have_posts()) : $the_query->the_post();
							$delay = 50 * $i; ?>
							<div class="landing-ingredients--item" data-aos="fade-up" data-aos-duration="600"
					...
					<div class="landing-ingredients--buttons" data-aos="fade-up" data-aos-duration="600"
						 data-aos-delay="50">
						<a href="<?php echo esc_url(home_url('/ingredienti')); ?>" class="btn btn-primary"
						   title="Scopri gli ingredienti">Scopri gli ingredienti</a>
					</div>
				</div>
