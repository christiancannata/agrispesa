...
if ( apply_filters( 'woocommerce_checkout_show_terms', true ) && function_exists( 'wc_terms_and_conditions_checkbox_enabled' ) ) {
	...
	<div class="woocommerce-terms-and-conditions-wrapper">
		...
		<div class="checkbox-form form-agree">
			...
			<label for="terms">Ho letto e accetto i <a href="<?php echo esc_url( home_url( '/termini-condizioni' ) ); ?>" target="_blank">Termini e Condizioni</a> e la <a href="<?php echo esc_url( home_url( '/privacy-policy' ) ); ?>" target="_blank">Privacy Policy</a></label>
