...
?>
	<section class="woocommerce-order-details">
		...
		<h4 class="my-account--minititle"><?php esc_html_e('Order details', 'woocommerce'); ?></h4>
		...
		<table class="woocommerce-table woocommerce-table--order-details shop_table order_details">
			...
			foreach ($order_items as $item_id => $item) {
				...
				if (!$isSubscription) {
					...
					?>
					<tr>
						<td><?php echo $product->get_name(); ?> (<?php echo $weight . $unitaMisura ?>)<br>
							<i><?php echo $fornitoreString; ?></i></td>
						<td><?php echo 'x' . $item->get_quantity() ?></td>
					</tr>
					<?php
				}
