...
<h3 class="my-account--minititle address-title">I tuoi ordini</h3>
...
<?php else: ?>
	<div class="empty-states">
		...
		<div class="empty-states--text">
			...
			<a href="<?php echo esc_url(home_url('/')); ?>box/facciamo-noi"
			   class="btn btn-primary btn-small empty-states--button" title="Provala subito!"
			   class="empty-states--subtitle">Provala subito!</a>
		</div>
	</div>
<?php endif; ?>
