...
<?php if($subscription->get_status() == 'active'):?>
	...
	<div class="top_banner orange m-t">
		<p class="top_banner--advice">Sospendi l'abbonamento <strong>entro <span id="countdown"></span></strong> se non vuoi ricevere questa scatola.</p>
	</div>
	<?php
...
<?php else: ?>
	<div class="top_banner">
		<p class="top_banner--advice">Riattiva <strong>entro <span id="countdown"></span></strong> se vuoi ricevere la scatola della prossima settimana.</p>
	</div>
<?php endif;?>
