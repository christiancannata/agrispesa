	...
	<div class="agr-cart">
		<form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
			...
			<div class="new-cart--actions">
				<button type="submit" class="btn btn-secondary btn-small btn-cart-update" name="update_cart"
						value="<?php esc_attr_e('Update cart', 'woocommerce'); ?>"><?php esc_attr_e('Update cart', 'woocommerce'); ?></button>
