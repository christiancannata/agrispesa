...
<link rel="mask-icon" href="<?php echo get_template_directory_uri(); ?>/assets/images/favicon/safari-pinned-tab.svg" color="#479460">
<meta name="msapplication-TileColor" content="#ffffff">
<meta name="theme-color" content="#ffffff">


<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/assets/css/aos.css">
<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/assets/fonts/emoji/emoji.min.css">
...
<header class="header">
	...
	<div class="header--flex">
		<div class="header--brand">
			...
			<div class="main-logo">
	      <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="main-logo--link" title="<?php bloginfo( 'name' ); ?>">
					<span>
						<?php bloginfo( 'name' ); ?>
					</span>
	      </a>
		...
		<div class="top-user">
				<?php if ( is_user_logged_in() ): ?>
					<div class="user-header">
						<a href="<?php echo wc_get_page_permalink( 'myaccount' ); ?>" class="top-user__link user-link-mobile get-user-menu">
						<span class="top-user__name">Ciao, <?php echo $current_user->first_name; ?> <span class="icon-arrow-right top-user__arrow"></span></span>
						</a>
				...
				<?php else: ?>
				<a href="<?php echo wc_get_page_permalink( 'myaccount' ); ?>" class="link-icon top-user__login"><span class="icon-account"></span>Accedi</a>
			<?php endif; ?>
